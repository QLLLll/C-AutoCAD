...
//-----------------------------------------------------------------------------
//----- CMyDocReactor.h : Declaration of the CMyDocReactor
//-----------------------------------------------------------------------------
#pragma once

#ifdef MYREACTOR_MODULE
...
class /*DLLIMPEXP*/ CMyDocReactor : public AcApDocManagerReactor {

public:
	ACRX_DECLARE_MEMBERS(CMyDocReactor) ;
...
public:
	CMyDocReactor (const bool autoInitAndRelease =true) ;
...
#ifdef MYREACTOR_MODULE
ACDB_REGISTER_OBJECT_ENTRY_AUTO(CMyDocReactor)
#endif
