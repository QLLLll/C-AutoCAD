...
//-----------------------------------------------------------------------------
//----- MyObjectReactor.h : Declaration of the CMyObjectReactor
//-----------------------------------------------------------------------------
#pragma once
...
//-----------------------------------------------------------------------------
class DLLIMPEXP CMyObjectReactor : public AcDbObject {
...
#ifdef MYREACTOR_MODULE
ACDB_REGISTER_OBJECT_ENTRY_AUTO(CMyObjectReactor)
#endif
