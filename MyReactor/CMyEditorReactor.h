...
//-----------------------------------------------------------------------------
//----- CMyEditorReactor.h : Declaration of the CMyEditorReactor
//-----------------------------------------------------------------------------
#pragma once
...
class /*DLLIMPEXP*/ CMyEditorReactor : public AcEditorReactor {
...
public:
	CMyEditorReactor (const bool autoInitAndRelease =true) ;
