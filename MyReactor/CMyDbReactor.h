...
//-----------------------------------------------------------------------------
//----- CMyDbReactor.h : Declaration of the CMyDbReactor
//-----------------------------------------------------------------------------
#pragma once
...
class /*DLLIMPEXP*/ CMyDbReactor : public AcDbDatabaseReactor {

public:
	ACRX_DECLARE_MEMBERS(CMyDbReactor) ;
...
public:
	CMyDbReactor (AcDbDatabase *pDb =NULL) ;
...
#ifdef MYREACTOR_MODULE
ACDB_REGISTER_OBJECT_ENTRY_AUTO(CMyDbReactor)
#endif
